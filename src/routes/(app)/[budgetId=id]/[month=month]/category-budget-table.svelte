<script lang="ts">
	...
	import GettingStartedCard from './getting-started-card.svelte';
...
<!-- The Getting started card (see CONTEXT.md) replaces the entire table region —
     desktop header row included — while the budget has no categories. -->
{#if month !== null && categories.length === 0}
	<GettingStartedCard />
{:else}
	<div role="table">
