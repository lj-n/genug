<script lang="ts">
	...
	// PROTOTYPE (#260) — Round 2, Variant B "Rail · tinted pill": the quiet
	// rail with today's active idiom carried over — a rounded bg-info/10 pill
	// with info-colored text. The strongest color dose of the round. Delete
	// with the prototype.
