...
<div
	class="flex w-full max-w-xs flex-col gap-1 rounded-md bg-muted/5 p-3 @3xl/main:w-fit @3xl/main:max-w-none @3xl/main:flex-row @3xl/main:flex-wrap @3xl/main:items-center @3xl/main:gap-x-6 @3xl/main:gap-y-2"
>
	<div
